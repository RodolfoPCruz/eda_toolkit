...
def sample_df_eps_search():
    ...
    This fixture provides a DataFrame with two feature columns
    ('feature1' and 'feature2'), generated using the `make_blobs` function
    from scikit-learn. The DataFrame contain 200 samples, with three
    clusters of points, for testing the `search_eps_dbscan`function.
